...
export class ModalAddEditHeroComponent implements OnInit {
  ...
  formControls = ['firstName', 'lastName', 'heroName', 'heroPower'];
  
  constructor(
    private fb: FormBuilder,
    // los datos traidos del padre
    @Inject(MAT_DIALOG_DATA) private dataFromNewHero,
    // modal (usamos para cerrarla una vez hecha la petición)
    private dialogRef: MatDialogRef<ModalAddEditHeroComponent>,
    // servicio solicitado
  ...
  submitData(): void{​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​
    if (this.dataFromNewHero.modalType === 'new') {​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​
      ...
      this.heroService.saveHero(this.heroForm.value).subscribe(res => {​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​
